...
public class NetWorkUtil {
     ...
     */
    public static boolean netWorkIsConnection() {
    ...
    public static boolean isWifiAvailable() {
        return getWifiEnabled() && netWorkIsConnection();
    }
    ...
    public static boolean isWifiProxy() {
        ...
        if (is_ics_or_later) {
            ...
            proxyAddress = android.net.Proxy.getHost(MyApplication.getInstace());
            proxyPort = android.net.Proxy.getPort(MyApplication.getInstace());
        }
