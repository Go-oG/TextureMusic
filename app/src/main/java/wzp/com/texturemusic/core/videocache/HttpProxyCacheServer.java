...
import wzp.com.texturemusic.core.videocache.file.Md5FileNameGenerator;
import wzp.com.texturemusic.core.videocache.file.TotalCountLruDiskUsage;
import wzp.com.texturemusic.core.videocache.file.TotalSizeLruDiskUsage;
...
import static wzp.com.texturemusic.core.videocache.Preconditions.checkAllNotNull;
...
public class HttpProxyCacheServer {
    ...
    private final ExecutorService socketProcessor = Executors.newFixedThreadPool(3);
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            this.serverSocket = new ServerSocket(0, 3, inetAddress);
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                LogUtil.e(TAG, "Error registering cache listener " + e.getMessage());
            }
        }
    }
    ...
    private boolean isAlive() {
        return pinger.ping(2, 50);   // 70+140+280=max~500ms
    }
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            LogUtil.e(TAG, "Error touching file  " + e.getMessage());
        }
    }
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            LogUtil.d(TAG, "Opened connections: " + getClientsCount());
        }
    }
    ...
    private void closeSocketOutput(Socket socket) {
        try {
            ...
            LogUtil.e(TAG, "Failed to close socket on proxy side: {}. It seems client have already closed connection." + e.getMessage());
        }
    }
    ...
    private void onError(Throwable e) {
        LogUtil.e(TAG, "HttpProxyCacheServer error" + e.getMessage());
    }
