...
/**
 * Created by Go_oG
 * Description:个性推荐页面的artist适配器
 * on 2017/10/5.
 */

public class IndexPersonArtistAdapter extends BaseAdapterForVlayout<IndexPersonEntiy,IndexPersonViewHolder> {


    public IndexPersonArtistAdapter(Context c) {
        super(c);
    }
    ...
    @Override
    public void onBindViewHolder(IndexPersonViewHolder holder, final int position) {
